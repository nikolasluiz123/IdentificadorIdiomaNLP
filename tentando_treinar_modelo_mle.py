from funcoes_nltk import treinar_modelo_mle, calcular_perplexidade_mle
...
modelo_portugues = treinar_modelo_mle(resultado_train_test_split_portugues)
modelo_ingles = treinar_modelo_mle(resultado_train_test_split_ingles)
modelo_espanhol = treinar_modelo_mle(resultado_train_test_split_espanhol)

perplexidade_portugues = calcular_perplexidade_mle(modelo_portugues, resultado_train_test_split_portugues)
perplexidade_ingles = calcular_perplexidade_mle(modelo_ingles, resultado_train_test_split_ingles)
perplexidade_espanhol = calcular_perplexidade_mle(modelo_espanhol, resultado_train_test_split_espanhol)

# A perplexidade vai dar infinito pois quando é calculada com alguma palavra que está no teste e não estava no treino
# é realizada uma divisão por zero pois a probabilidade que o MLE tem daquela palavra é zero.
